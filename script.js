    ...
    if (contactForm) {
        ...
        const validateField = function(input) {
            ...
            if (input.hasAttribute('maxlength') && value.length > parseInt(input.getAttribute('maxlength'))) {
                showError(input, fieldName + ' must be no more than ' + input.getAttribute('maxlength') + ' characters');
                return false;
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '76277206-39b5-46af-86a7-b6bd0288f34a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '76277206-39b5-46af-86a7-b6bd0288f34a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '76277206-39b5-46af-86a7-b6bd0288f34a';
